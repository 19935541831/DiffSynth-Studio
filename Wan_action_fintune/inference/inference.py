...
def main():
    ...
    parser.add_argument(
        "--lora_dir",
        type=str,
        default="/project/peilab/Puxin/Wan_action/checkpoints/Wan2.1-I2V-14B-480P_lora",
        help="Directory containing LoRA checkpoints (optional)"
    )
    parser.add_argument(
        "--lora_epoch",
        type=int,
        default=None,
        help="Specific LoRA epoch to load (default: latest)"
    )
    parser.add_argument(
        "--output_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=15,
        help="Frame rate for output video (default: 15)"
    )
    parser.add_argument(
        "--quality",
        type=int,
    ...
    # Manually initialize and load action encoder
    ...
    # Load LoRA weights if directory exists
    ...
    for idx, row in enumerate(tqdm(rows, desc="Generating videos")):
        try:
            ...
            action_seq = load_action_seq(action_seq_path)
