...
def main():
    ...
    feature_extractor = VideoMAEImageProcessor.from_pretrained("/project/peilab/licheng/models/videomae-base", size=args.img_size)
    cfg = VideoMAEConfig.from_pretrained("/project/peilab/licheng/models/videomae-base", num_frames=8, num_labels=2)
    model = VideoMAEForVideoClassification.from_pretrained("/project/peilab/licheng/models/videomae-base", config=cfg).to(device)
